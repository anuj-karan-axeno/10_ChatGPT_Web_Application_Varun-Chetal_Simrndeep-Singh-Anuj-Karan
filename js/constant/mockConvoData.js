...
export const mockConversations = [
    ...
    },
    {
        ...
        messages: [
            { role: "user", content: "When should I use CSS Grid instead of Flexbox? When should I use CSS Grid instead of Flexbox? When should I use CSS Grid instead of Flexbox?When should I use CSS Grid instead of Flexbox?When should I use CSS Grid instead of Flexbox?When should I use CSS Grid instead of Flexbox?When should I use CSS Grid instead of Flexbox? use CSS Grid instead of Flexbox? When should I use CSS Grid instead of Flexbox? When should I use CSS Grid instead of Flexbox?When should I use CSS Grid instead of Flexbox?When should I use CSS Grid instead of Flexbox?When should I use CSS Grid instead of Flexbox?When should I use CSS Grid instead of Flexbox?use CSS Grid instead of Flexbox? When should I use CSS Grid instead of Flexbox? When should I use CSS Grid instead of Flexbox?When should I use CSS Grid instead of Flexbox?When should I use CSS Grid instead of Flexbox?When should I use CSS Grid instead of Flexbox?When should I use CSS Grid instead of Flexbox?use CSS Grid instead of Flexbox? When should I use CSS Grid instead of Flexbox? When should I use CSS Grid instead of Flexbox?When should I use CSS Grid instead of Flexbox?When should I use CSS Grid instead of Flexbox?When should I use CSS Grid instead of Flexbox?When should I use CSS Grid instead of Flexbox?" },
